...
LANGUAGE.press_jump_to_free_roam					= "점프 키를 눌러 배회하기"
...
LANGUAGE.press_reload_to_spawn_at_normal_point		= "재장전 키를 눌러 기본 스폰 지점에서 부활"
LANGUAGE.press_walk_to_spawn_as_x					= "걷기 키를 눌러 다음으로 부활: %s"
...
LANGUAGE.boss_class_select							= "보스 좀비가 되면 다음으로 부활: %s"
...
LANGUAGE.x_will_be_y_soon							= "%s님이 곧 다음 클래스로 부활한다! [%s]"
LANGUAGE.you_will_be_x_soon							= "곧 다음 클래스로 부활한다! [%s]"
...
LANGUAGE.not_enough_room_for_a_nest					= "둥지를 지을 공간이 부족하다!"
LANGUAGE.too_close_to_another_nest					= "다른 둥지가 너무 가까이 있다!"
LANGUAGE.nest_created								= "둥지가 만들어졌다. 완성되면 다른 좀비가 부활할 수 있다!"
LANGUAGE.nest_built_by_x							= "%s님에 의해 둥지가 완성되었으며 이곳에서 스폰할 수 있다!"
LANGUAGE.nest_destroyed								= "둥지가 파괴되었다."
LANGUAGE.wait_x_seconds_before_making_a_new_nest	= "새 둥지를 짓기 위해선 %d초를 기다려야 한다."
LANGUAGE.too_close_to_a_human						= "인간과 너무 가까이 있다!"
LANGUAGE.too_close_to_a_spawn						= "좀비 스폰 지점과 너무 가까이 있다!"
LANGUAGE.x_has_built_this_nest_and_is_still_around	= "둥지를 지은 %s님이 아직 근처에 살아있어 파괴할 수 없다."
LANGUAGE.no_other_nests								= "둥지가 하나밖에 안 남아 파괴할 수 없다."
LANGUAGE.no_free_channel							= "사용중인 라디오 채널이 너무 많아 사용할 수 없다."
LANGUAGE.sigil_destroyed							= "언데드가 마법진을 파괴했다!"
...
LANGUAGE.prop_obj_exit_h							= "탈출해!"
LANGUAGE.prop_obj_exit_z							= "저지해!"
...
LANGUAGE.description_butcher						= "미친 언데드 도살자. 터프한 아저씨는 아지만 근처에 다가간 불행한 인간을 단숨에 썰어버릴 성깔은 있다."
LANGUAGE.description_flesh_creeper					= "크리퍼는 둥지를 지을 수 있는 능력을 가지고 있다.\n이 둥지에서 다른 좀비들이 부활할 수 있다.\n어떻게 동작하는진 모르겠지만 인간들은 생존을 위해 반드시 부숴야 한다."
LANGUAGE.description_gore_child						= "좀비화 된 태아.\n이들의 힘은 그 숫자에 비례한다."
LANGUAGE.description_giga_gore_child				= ".\n거대한 몸뚱이는 모두 좀비화 된 줄기세포로 이뤄져있다.\n줄기세포로부터 처키들을 무한히 생성해 낼 수 있는 것 같다."
...
LANGUAGE.controls_butcher							= "> 공격 1: 썰기"
LANGUAGE.controls_flesh_creeper						= "> 공격 1: 박치기\n> SECONDARY: 둥지 짓기"
LANGUAGE.controls_gore_child						= "> 공격 1: 할퀴기"
LANGUAGE.controls_giga_gore_child					= "> 공격 1: 강타\n> SECONDARY: 처키 생산"
