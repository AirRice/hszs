...
GM:AddStartingItem("z9000", "'Z9000' 펄스 피스톨", nil, ITEMCAT_GUNS, 50, "weapon_zs_z9000")
...
GM:AddStartingItem("150mkit", "150 의료킷 에너지", "150 의료킷 에너지 충전.", ITEMCAT_TOOLS, 30, nil, function(pl) pl:GiveAmmo(150, "Battery", true) end, "models/healthvial.mdl")
...
GM:AddStartingItem("dbfnoghosting", "뚱땡이", "프롭 사이를 통과할 수 없게 된다.", ITEMCAT_RETURNS, -20, nil, function(pl) pl.NoGhosting = true end, "models/gibs/HGIBS.mdl").NoClassicMode = true
...
GM:AddPointShopItem("medgun", "메딕 건", nil, ITEMCAT_TOOLS, 175, "weapon_zs_medicgun")
