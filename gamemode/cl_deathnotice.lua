...
killicon.AddFont("weapon_zs_sharpshooter", "zsdeathnoticecs", "e", color_white)
...
killicon.AddFont("weapon_zs_g3sg1", "zsdeathnoticecs", "i", color_white)
...
killicon.AddFont("weapon_zs_sg552", "zsdeathnoticecs", "A", color_white)
